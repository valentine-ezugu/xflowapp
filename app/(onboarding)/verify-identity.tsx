...
export default function VerifyIdentityScreen() {
  ...
  const handleStartVerification = async () => {
    try {
      ...
      // Format: universal > colors > propertyName with light/dark values
      const darkTheme = {
        universal: {
          colors: {
            backgroundCommon: { light: '#000000', dark: '#000000' },
            backgroundNeutral: { light: '#111111', dark: '#111111' },
            backgroundInfo: { light: '#0d2922', dark: '#0d2922' },
            backgroundSuccess: { light: '#0d2922', dark: '#0d2922' },
            backgroundWarning: { light: '#2a2000', dark: '#2a2000' },
            backgroundCritical: { light: '#2a1515', dark: '#2a1515' },
            cardPlainBackground: { light: '#111111', dark: '#111111' },
            cardBorderedBackground: { light: '#111111', dark: '#111111' },
            contentStrong: { light: '#ffffff', dark: '#ffffff' },
            contentNeutral: { light: '#888888', dark: '#888888' },
            contentWeak: { light: '#666666', dark: '#666666' },
            contentLink: { light: '#00D4AA', dark: '#00D4AA' },
            contentSuccess: { light: '#00D4AA', dark: '#00D4AA' },
            contentWarning: { light: '#FFB800', dark: '#FFB800' },
            contentCritical: { light: '#FF6B6B', dark: '#FF6B6B' },
            primaryButtonBackground: { light: '#00D4AA', dark: '#00D4AA' },
            primaryButtonBackgroundHighlighted: { light: '#00B894', dark: '#00B894' },
            primaryButtonBackgroundDisabled: { light: '#1a3d35', dark: '#1a3d35' },
            primaryButtonContent: { light: '#000000', dark: '#000000' },
            primaryButtonContentHighlighted: { light: '#000000', dark: '#000000' },
            primaryButtonContentDisabled: { light: '#666666', dark: '#666666' },
            secondaryButtonBackground: { light: '#222222', dark: '#222222' },
            secondaryButtonBackgroundHighlighted: { light: '#333333', dark: '#333333' },
            secondaryButtonContent: { light: '#ffffff', dark: '#ffffff' },
            cameraBackground: { light: '#000000', dark: '#000000' },
            bottomSheetBackground: { light: '#111111', dark: '#111111' },
            bottomSheetHandle: { light: '#333333', dark: '#333333' },
            fieldBackground: { light: '#111111', dark: '#111111' },
            fieldBorder: { light: '#333333', dark: '#333333' },
            fieldPlaceholder: { light: '#666666', dark: '#666666' },
            fieldContent: { light: '#ffffff', dark: '#ffffff' },
            navigationBarItem: { light: '#ffffff', dark: '#ffffff' },
            toolbarTint: { light: '#ffffff', dark: '#ffffff' },
            toolbarBackground: { light: '#000000', dark: '#000000' },
          },
        },
      };
